...
export const saveTransactions = async (db, payload) => {
...
export const getAllTransactions = async (db, registeredSchema) => {
    const savedTransactions = await getTransactions(db);
...
export const getNFTHistory = async (db, dbKey) => {
    try {
...
export const saveNFTHistory = async (db, decodedBlock, registeredModules, channel) => {
